...
![](C:\books\markdown\ip\ip-message.png)
...
![](C:\books\markdown\ip\ip-router.png)
...
![](C:\books\markdown\ip\ip-address-1.png)
...
![](C:\books\markdown\ip\ip-address.png)

有了 `IP地址` 后，就可以为互联网上的每台计算机设置 `IP地址`，如下图：

![](C:\books\markdown\ip\ip-network-2.png)
...
![](C:\books\markdown\ip\ip-header.png)
...
![](C:\books\markdown\ip\ip-package.png)
